    ...
    render () {
        ...
        if (this.props.error) {
            ...
            if(this.props.error.message === "EMAIL_EXISTS"){
                errorMessage = (
                    <p>This email is already registered. Please sing in.</p>
                );
            }
            ...
            if(this.props.error.message === "WEAK_PASSWORD : Password should be at least 6 characters"){
                errorMessage = (
                    <p className="text-danger"> Weak password. Your password needs to be at least 6 characters.</p>
                );
            }
        ...
        return (
            <div className={classes.Auth}>
                {authRedirect}
                <p style={{color:"#d48600"}}>{!this.state.isSignup ? 'SIGN IN' : 'SIGN UP'}</p>
                {errorMessage}
